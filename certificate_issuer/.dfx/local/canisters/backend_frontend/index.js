...
export const canisterId = process.env.CANISTER_ID_BACKEND_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./backend_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the backend_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./backend_frontend.did.js")._SERVICE>}
 */
export const backend_frontend = createActor(canisterId);
