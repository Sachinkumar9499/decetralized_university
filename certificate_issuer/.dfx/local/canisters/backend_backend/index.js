...
export const canisterId = process.env.CANISTER_ID_BACKEND_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./backend_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the backend_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./backend_backend.did.js")._SERVICE>}
 */
